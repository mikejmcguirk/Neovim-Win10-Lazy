...
function M.do_ftplugin()
    ...
    if fn.win_gettype(0) == "loclist" then
        ...
        api.nvim_buf_set_keymap(0, "n", "rF", "<Plug>(qf-herder-sort-ll-fname-desc)", opts)
        api.nvim_buf_set_keymap(0, "n", "rI", "<Plug>(qf-herder-sort-ll-sev-desc)", opts)
        api.nvim_buf_set_keymap(0, "n", "rf", "<Plug>(qf-herder-sort-ll-fname-asc)", opts)
        api.nvim_buf_set_keymap(0, "n", "ri", "<Plug>(qf-herder-sort-ll-sev-asc)", opts)
        ...
        api.nvim_buf_set_keymap(0, "n", "rF", "<Plug>(qf-herder-sort-qf-fname-desc)", opts)
        api.nvim_buf_set_keymap(0, "n", "rI", "<Plug>(qf-herder-sort-qf-sev-desc)", opts)
        api.nvim_buf_set_keymap(0, "n", "rf", "<Plug>(qf-herder-sort-qf-fname-asc)", opts)
        api.nvim_buf_set_keymap(0, "n", "ri", "<Plug>(qf-herder-sort-qf-sev-asc)", opts)
