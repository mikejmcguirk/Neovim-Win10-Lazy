...
{ nmode, "<Plug>(qf-herder-qf-clear)", { prefix_qf .. stack_clear }, "", "Clear the [count] quickfix list", function() qfr.stack.q_clear() end },
...
{ nmode, "<Plug>(qf-herder-ll-clear)", { prefix_ll .. stack_clear }, "", "Clear the [count] location list", function() qfr.stack.l_clear() end },
