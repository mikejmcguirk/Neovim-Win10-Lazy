...
- [ ] For fdo_cmd, do any other cmds need to be supported?
- [ ] For fdo_cmd, I think I have "" as an option for some reason. nil should just default to zv I think. Though I guess the idea is that you don't want to have an fdo opt and fdo_cmd in there. But buf_open is meant to be a sub-function of other things, do you don't need the whole fdo opt
