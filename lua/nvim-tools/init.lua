...
---@return nvim-tools.init.Config The current or updated config.
...
M.config = config_create() ---@type nvim-tools.init.Config
...
---@field _configs table<uinteger, nvim-tools.init.Config>
...
---@return nvim-tools.init.Config The current or updated buf config.
---@diagnostic disable-next-line: assign-type-mismatch
...
---@return nvim-tools.init.config.BufAccessor
...
---@nodoc
M.buf_config = buf_config_create() ---@type nvim-tools.init.config.BufAccessor
...
---@param buf uinteger
---@param _configs table<uinteger, nvim-tools.init.Config> Modified in place!
...
Buf_Config_Accessor.__index = function(self, k)
    ...
    local buf_config = rawget(_configs, k) ---@type nvim-tools.init.Config
...
function Buf_Config_Accessor:add(buf)
    ...
    ---@type table<uinteger, nvim-tools.init.Config>
    local _configs = rawget(self, "_configs")
...
function Buf_Config_Accessor:clear(bufs)
    ...
    local _configs = rawget(self, "_configs") ---@type table<uinteger, nvim-tools.init.Config>
    if bufs == nil then
...
function M._get_merged_config(buf, usr_config, ...)
    ...
    local buf_config_get = rawget(_configs, buf) ---@type nvim-tools.init.Config
