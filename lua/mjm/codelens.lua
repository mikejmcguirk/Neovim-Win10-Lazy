...
local namespaces = setmetatable({}, {
    __index = function(t, key)
        local value = api.nvim_create_namespace("mjm.codelens:" .. key)
        rawset(t, key, value)
        return value
    end,
})
...
local augroup = api.nvim_create_augroup("mjm.codelens", {})
...
local function execute_lens(lens, bufnr, client_id)
    ...
    -- vim.fn.confirm(vim.inspect(lens.command))
