...
local rancher_keymaps = {
    ...
    { nn, pqfr.. "Ldiags-n-hint",  lp.."in", "Cur buf diagnostics min hint"..n,            function() ed.diags("hint", { sev_type = "min" }, { action = "new", is_loclist = true }) end },
    { nn, pqfr.. "Ldiags-n-info",  lp.."if", "Cur buf diagnostics min info"..n,            function() ed.diags("info", { sev_type = "min" }, { action = "new", is_loclist = true }) end },
    { nn, pqfr.. "Ldiags-n-warn",  lp.."iw", "Cur buf diagnostics min warn"..n,            function() ed.diags("warn", { sev_type = "min" }, { action = "new" , is_loclist = true}) end },
    { nn, pqfr.. "Ldiags-n-error", lp.."ie", "Cur buf diagnostics min error"..n,           function() ed.diags("error", { sev_type = "min" }, { action = "new", is_loclist = true}) end },
    { nn, pqfr.. "Ldiags-n-top",   lp.."it", "Cur buf diagnostics top severity"..n,        function() ed.diags("top", { sev_type = "min" }, { action = "new", is_loclist = true }) end },
    ...
    { nn, pqfr.. "Ldiags-r-hint",  lp.."In", "Cur buf diagnostics min hint"..r,            function() ed.diags("hint", { sev_type = "min" }, { action = "replace", is_loclist = true }) end },
    { nn, pqfr.. "Ldiags-r-info",  lp.."If", "Cur buf diagnostics min info"..r,            function() ed.diags("info", { sev_type = "min" }, { action = "replace", is_loclist = true }) end },
    { nn, pqfr.. "Ldiags-r-warn",  lp.."Iw", "Cur buf diagnostics min warn"..r,            function() ed.diags("warn", { sev_type = "min" }, { action = "replace" , is_loclist = true}) end },
    { nn, pqfr.. "Ldiags-r-error", lp.."Ie", "Cur buf diagnostics min error"..r,           function() ed.diags("error", { sev_type = "min" }, { action = "replace", is_loclist = true}) end },
    { nn, pqfr.. "Ldiags-r-top",   lp.."It", "Cur buf diagnostics top severity"..r,        function() ed.diags("top", { sev_type = "min" }, { action = "replace", is_loclist = true }) end },
    ...
    { nn, pqfr.. "Ldiags-a-hint",  lp.."<C-i>n", "Cur buf diagnostics min hint"..a,        function() ed.diags("hint", { sev_type = "min" }, { action = "add", is_loclist = true }) end },
    { nn, pqfr.. "Ldiags-a-info",  lp.."<C-i>f", "Cur buf diagnostics min info"..a,        function() ed.diags("info", { sev_type = "min" }, { action = "add", is_loclist = true }) end },
    { nn, pqfr.. "Ldiags-a-warn",  lp.."<C-i>w", "Cur buf diagnostics min warn"..a,        function() ed.diags("warn", { sev_type = "min" }, { action = "add" , is_loclist = true}) end },
    { nn, pqfr.. "Ldiags-a-error", lp.."<C-i>e", "Cur buf diagnostics min error"..a,       function() ed.diags("error", { sev_type = "min" }, { action = "add", is_loclist = true}) end },
    { nn, pqfr.. "Ldiags-a-top",   lp.."<C-i>t", "Cur buf diagnostics top severity"..a,    function() ed.diags("top", { sev_type = "min" }, { action = "add", is_loclist = true }) end },
    ...
    { nn, pqfr.. "Ldiags-a-WARN",  lp.."<C-i>W", "Cur buf diagnostics only warn"..a,       function() ed.diags("warn", { sev_type = "only" }, { action = "add" , is_loclist = true}) end },
    { nn, pqfr.. "Ldiags-a-ERROR", lp.."<C-i>E", "Cur buf diagnostics only error"..a,      function() ed.diags("error", { sev_type = "only" }, { action = "add", is_loclist = true}) end },
    { nn, pqfr.. "Ldiags-a-TOP",   lp.."<C-i>T", "Cur buf diagnostics top severity"..a,    function() ed.diags("top", { sev_type = "top" }, { action = "add", is_loclist = true }) end },
