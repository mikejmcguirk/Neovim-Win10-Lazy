...
local buf_configs = {} ---@type table<uinteger, farsight.config.Partial>
...
---@param buf uinteger
---@return farsight.config.Partial
...
---@param buf uinteger
---@param new_config farsight.config.Partial?
---@return farsight.config.Partial
function M.buf_config(buf, new_config)
