; Overwrite defaults to remove some unneeded queries and improve performance
...
; Brackets
; I have these all set to fg. {} are constructors
; [
;   "("
;   ")"
;   "["
...
; Constants
; The semantic token hack handles these
((identifier) @constant
...
; I don't use a separate hl_group for these
; (function_call
